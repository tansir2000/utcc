...
// Copyright (c) 2013 The UTCC developers
...
uint256 hashGenesisBlock("0x00e7845ba1c23d3d1b2ddc36e58c72ba5b638b309c99b138f9360c44db01a3c5");
static const unsigned int timeGenesisBlock = 1541592872;
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 8); // joy joy
...
const string strMessageMagic = "UTCC Signed Message:\n";
...
static const int64 nGenesisBlockRewardCoin = 21000000 * COIN;
static const int64 nBlockRewardStartCoin = 0.001 * COIN;
...
*/
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x00e5ca0f892eaac3f53df46737736bf3e18f68f2277186c4d3a13fffd32a8e1e"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UTCCMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UTCCMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("UTCCMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("UTCC-miner");
    ...
    try { loop {
        ...
        printf("Running UTCCMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
