...
const QString BITCOIN_IPC_PREFIX("UTCC:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click UTCC: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start UTCC: click-to-pay handler");
    else
...
{
    // clicking on UTCC: URLs creates FileOpen events on the Mac:
